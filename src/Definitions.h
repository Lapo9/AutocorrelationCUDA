...
constexpr uint8 REPETITIONS = 20;
...
constexpr uint16 SHARED_MEMORY_REQUIRED = SENSORS_PER_BLOCK * GROUPS_PER_SENSOR * GROUP_SIZE + SENSORS_PER_BLOCK * GROUPS_PER_SENSOR + SENSORS_PER_BLOCK * GROUPS_PER_SENSOR + SENSORS_PER_BLOCK * GROUPS_PER_SENSOR * GROUP_SIZE * 4;
